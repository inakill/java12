package turpin.udemy.java12.java11.lambdaenhacement;
...
public class LambdaEnhancement {
	...
	private static void fromJava11() {
		...
		AddInterface1 addInterfaceFinal = (final  var a, final var b) -> (a + b);
		AddInterface1 addInterfaceMin = (@Min(value = 10)  var a, @Min(value = 1) var b) -> (a + b);
	}
