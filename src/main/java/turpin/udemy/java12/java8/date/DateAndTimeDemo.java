package turpin.udemy.java12.java8.date;
...
//		displayCurrentDate();
	...
	private static void isPasswordExpired() {
		final LocalDate passwordSetOnDate = LocalDate.of(2019, 1, 1);// Hard-coded for this assignment
		final long passwordExpiryDays = 30; // Hard-coded for this assignment
		LocalDate currentDate = LocalDate.now();

		// if the difference between Current date and password set on date is  > 30
		// Display message Your Password has expired
		if (currentDate.isAfter(passwordSetOnDate.plusDays(passwordExpiryDays))) {
